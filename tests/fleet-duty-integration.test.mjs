...
import { chicagoCalendarDate, currentChicagoWeek } from "../app/lib/fleet-projections.ts";
...
test("links weekly duties to Fleet, Daily Log, and Live Operations", async () => {
  const [duties, inventory, operations, logbook, dailyLog, dashboard, board] = await Promise.all([
