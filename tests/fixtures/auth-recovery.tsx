...
import {audit} from './auth-recovery-client';
...
createRoot(document.getElementById('root')!).render(<><p>Fictional authentication boundary audit · No production session</p><AuthGateway/></>);
