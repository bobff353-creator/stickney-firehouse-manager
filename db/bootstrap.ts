...
export async function ensureDatabase() {
  ...
  await db.batch([
    ...
    db.prepare("CREATE TABLE IF NOT EXISTS schedule_coverage_rules (id TEXT PRIMARY KEY NOT NULL, name TEXT NOT NULL, role TEXT NOT NULL, minimum_staff INTEGER NOT NULL, start_time TEXT NOT NULL, end_time TEXT NOT NULL, days_of_week TEXT NOT NULL DEFAULT '0,1,2,3,4,5,6', active INTEGER NOT NULL DEFAULT 1, created_by TEXT NOT NULL, created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP)"),
