...
export async function ensureDatabase() {
  ...
  await db.batch([
    ...
    db.prepare("CREATE TABLE IF NOT EXISTS schedule_assignments (id TEXT PRIMARY KEY NOT NULL, employee_id TEXT REFERENCES employees(id), work_date TEXT NOT NULL, start_time TEXT NOT NULL, end_time TEXT NOT NULL, role TEXT NOT NULL, source TEXT NOT NULL DEFAULT 'manual', rotation_id TEXT REFERENCES schedule_rotations(id), status TEXT NOT NULL DEFAULT 'assigned', emergency INTEGER NOT NULL DEFAULT 0, notes TEXT NOT NULL DEFAULT '', created_by TEXT NOT NULL, created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP)"),
    ...
    db.prepare("CREATE TABLE IF NOT EXISTS schedule_requests (id TEXT PRIMARY KEY NOT NULL, request_type TEXT NOT NULL, employee_id TEXT NOT NULL REFERENCES employees(id), assignment_id TEXT REFERENCES schedule_assignments(id), target_employee_id TEXT REFERENCES employees(id), start_date TEXT NOT NULL, end_date TEXT NOT NULL, start_time TEXT NOT NULL DEFAULT '', end_time TEXT NOT NULL DEFAULT '', role TEXT NOT NULL DEFAULT '', repeat_mode TEXT NOT NULL DEFAULT 'none', status TEXT NOT NULL DEFAULT 'pending', notes TEXT NOT NULL DEFAULT '', reviewed_by TEXT, reviewed_at TEXT, created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP)"),
