...
export default function PhoneNumbers() {
  ...
  return <section className="phone-page">
    <div className="phone-hero">
      <div><p className="eyebrow">Quick reference directory</p><h1>Important Phone Numbers</h1><p>Tap any number to call. For an active emergency, always call <a href="tel:911">911</a>.</p></div>
