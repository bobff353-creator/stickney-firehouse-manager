...
export default function RoleDashboard({ data, onNavigate, allowedPages }: { data: DashboardData; onNavigate: (page: PortalPage, record?: PortalRecord) => void; allowedPages: readonly PortalPage[] }) {
  ...
  return <section className="role-dashboard">
    ...
    <section className="home-task-start" aria-labelledby="home-task-title"><h2 id="home-task-title">What do you need to do?</h2><p>Choose a task. Each screen shows the next step and a way back.</p><div className="chief-quick-access" aria-label="Start a common task" data-test-safe>{([
