...
export default function FieldPreplans() {
  ...
  return <section className={`field-preplans-page${recordFocused?" preplan-builder-focused":""}${hydrantDraft?" hydrant-record-focused":""}`}>
    ...
    {draft&&recordMode==="edit"&&<section className="preplan-editor">
      ...
      {tab==="operational"&&current&&<div className="preplan-operational-edit"><OperationalPreplanPanel preplanId={current.id} canEdit={canEdit} mapDraft={operationalMapDraft} selectedSpaceId={selectedOperationalSpaceId} onMapOverlayChange={handleOperationalOverlay} onMapDrawingStart={startOperationalDrawing} onMapDrawingChange={changeOperationalDrawing} onMapFocus={()=>focusMapPanel.current?.scrollIntoView({behavior:"smooth",block:"start"})} onSpaceSelect={setSelectedOperationalSpaceId}/></div>}
