...
export async function GET(request: Request) {
  try {
    ...
    const [plan, levels, spaces, alerts, hazmat, zones, annotations, assets, hoseLays, risks, reviews, revisions, permissionValues] = await Promise.all([
