...
export const adminNavGroups: Array<{ label: string; icon: IconName; items: Array<{ label: string; page: NavItem }> }> = [
  ...
  { label: "Private pilots", icon: "document", items: [{ label: "Training · Private pilot", page: "Training" }, { label: "Fire Inspections · Private pilot", page: "Fire Inspections" }] },
