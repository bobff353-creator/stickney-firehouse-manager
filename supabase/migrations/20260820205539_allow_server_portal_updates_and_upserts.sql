...
BEGIN
  ...
  END IF;
  -- UPDATE ... SET and INSERT ... ON CONFLICT DO ... are the only supported
  -- statement families that use these words. The leading-command allowlist
  -- already prevents standalone SET and DO statements.
