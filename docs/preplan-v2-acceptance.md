...
| D — Hose lay | Segment totals, reserve and section rounding, independent supply options, verified capacity comparison, deficit, and unverified-not-zero behavior | Draw route geometry and compare the persisted result against a verified test apparatus inventory | Partial on isolated preview: source, segments, totals, recommendation, reload, archive, and cleanup verified |
