...
- Browser interaction with the original Chrome session became unavailable partway through the audit. Source inspection and local fictional-record checks continued; this is why the evidence column separates live, source, and local verification.
